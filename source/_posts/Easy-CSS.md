...
<pre><code>cssCopy codeh1 {
  font-size: 16px;
}
</code></pre>
<p>   多个声明可以组合在一个样式规则中：</p>
<pre><code>cssCopy codeh2 {
  color: blue;
  font-size: 18px;
  margin-bottom: 10px;
}
...
<pre><code>htmlCopy code&lt;!DOCTYPE html&gt;
&lt;html lang=&quot;en&quot;&gt;
&lt;head&gt;
  &lt;meta charset=&quot;UTF-8&quot;&gt;
...
<pre><code>cssCopy codeinput[type] {
...
<pre><code>cssCopy codea[href=&quot;https://example.com&quot;] {
...
<pre><code>cssCopy codep[class~=&quot;important&quot;] {
...
<pre><code>cssCopy codea[href^=&quot;https://&quot;] {
...
<pre><code>cssCopy codeimg[src$=&quot;.png&quot;] {
...
<pre><code>cssCopy codea[href*=&quot;example&quot;] {
...
<pre><code>cssCopy code@font-face {
...
<pre><code>cssCopy codep:first-letter {
  font-size: 150%;
}
...
<pre><code>cssCopy codeinput {
  float: left;
}
</code></pre>
</li>
<li><p><code>cursor</code>：定义鼠标悬停在表单元素上时的光标形状。例如：</p>
<pre><code>cssCopy codebutton {
  cursor: pointer;
}
</code></pre>
</li>
...
<pre><code>cssCopy codebutton:active {
...
<pre><code>cssCopy codeinput:focus {
  border: 2px solid blue;
}
</code></pre>
</li>
<li><p><strong>:first-child</strong> - 选择元素的第一个子元素。</p>
<pre><code>cssCopy codeli:first-child {
  font-weight: bold;
}
</code></pre>
</li>
<li><p><strong>:last-child</strong> - 选择元素的最后一个子元素。</p>
<pre><code>cssCopy codediv p:last-child {
  margin-bottom: 0;
}
</code></pre>
</li>
<li><p><strong>:nth-child(n)</strong> - 选择元素的第 n 个子元素。</p>
<pre><code>cssCopy codeli:nth-child(odd) {
...
<pre><code>cssCopy codep:nth-of-type(2) {
  color: red;
}
</code></pre>
...
<pre><code>cssCopy codebutton:hover {
...
<pre><code>cssCopy codea:visited {
  color: purple;
}
</code></pre>
</li>
...
<pre><code>cssCopy codeinput[type=&quot;checkbox&quot;]:checked {
...
<pre><code>cssCopy codeinput:enabled {
...
<pre><code>cssCopy codeinput:disabled {
...
<pre><code>cssCopy code::selection {
  background-color: #3498db;
  color: #fff;
}
</code></pre>
...
<pre><code>cssCopy code.container {
  perspective: 1000px;
}
</code></pre>
</li>
...
<pre><code>cssCopy code@keyframes animationName {
  from {
...
<pre><code>cssCopy code@keyframes slide-in {
  from {
...
<pre><code>cssCopy code.section1 .content {
  /* 样式规则 */
}
</code></pre>
</li>
...
<pre><code>cssCopy code.transition {
